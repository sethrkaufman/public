...
Gist
 ...
 Watch 8
  Star 3
  Fork 4 accesio/AIOUSB
 Code  Issues 4  Pull requests 0  Wiki  Pulse  Graphs
Branch: master Find file Copy pathAIOUSB/AIOUSB/samples/USB-DIO-32/sample.py
dabc488  on Jun 9, 2014
@accesio accesio ENH: Fixes for build on Cygwin for make and cmake
1 contributor
RawBlameHistory     Executable File  110 lines (92 sloc)  3.48 KB
#!/usr/bin/python
# @file   sample.py
# @author $Format: %an <%ae>$
# @date   $Format: %ad$
